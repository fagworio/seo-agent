...
async function authenticated(page: Page) {
  ...
  await page.route("**/api/v1/dashboard/title-impact", (route) => route.fulfill({ status: 200, contentType: "application/json", body: JSON.stringify({ title_impact: { generated_at: "2026-09-01T12:00:00Z", titles_modified_total: 21, titles_modified_period: 4, previous_period_delta: 1, measurable_7d: 14, measurable_28d: 0, measurable_90d: 0, awaiting_measurement: 7, benchmark: { data_status: "unavailable", source: "control_group", clicks_delta_percent: null, adjusted_click_delta_percent: null, limitation: "Ainda não há grupo de controle comparável persistido." }, windows: { "7": { days: 7, measured_titles: 14, awaiting_measurement: 7, data_status: "available", observed: { clicks: { before: 100, after: 125, delta: 25, delta_percent: 25 }, impressions: { before: 1000, after: 1100, delta: 100, delta_percent: 10 }, ctr: { before: .1, after: .1136, delta: .0136, delta_percent: 13.6 }, position: { before: 10, after: 8, delta: -2, gain: 2, delta_percent: null } }, forecast: { clicks_delta: 20, clicks_delta_percent: 20 }, outcomes: { improved: 9, neutral: 3, worsened: 2, insufficient_data: 0, improvement_rate: 64.3 }, timeline: [{ date: "2026-08", modified_titles: 14, observed_index: 125, forecast_index: 120, benchmark_index: null }], top_gains: [{ url: "https://site.test/gojo", label: "idade do gojo", clicks_delta: 25, ctr_delta_pp: 1.36, position_gain: 2 }], limitations: "Cada título usa uma comparação antes/depois de mesma duração." }, "28": { days: 28, measured_titles: 0, awaiting_measurement: 21, data_status: "missing", observed: { clicks: { before: null, after: null, delta: null, delta_percent: null }, impressions: { before: null, after: null, delta: null, delta_percent: null }, ctr: { before: null, after: null, delta: null, delta_percent: null }, position: { before: null, after: null, delta: null, gain: null, delta_percent: null } }, forecast: { clicks_delta: null, clicks_delta_percent: null }, outcomes: {}, timeline: [], top_gains: [], limitations: "" }, "90": { days: 90, measured_titles: 0, awaiting_measurement: 21, data_status: "missing", observed: { clicks: { before: null, after: null, delta: null, delta_percent: null }, impressions: { before: null, after: null, delta: null, delta_percent: null }, ctr: { before: null, after: null, delta: null, delta_percent: null }, position: { before: null, after: null, delta: null, gain: null, delta_percent: null } }, forecast: { clicks_delta: null, clicks_delta_percent: null }, outcomes: {}, timeline: [], top_gains: [], limitations: "" } } } }) }));
