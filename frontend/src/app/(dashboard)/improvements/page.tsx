...
function verdictLabel(verdict: string | null | undefined) { const m: Record<string, string> = { improved: "Dentro do esperado", neutral: "Neutro", worsened: "Piorou", insufficient_data: "Dados insuficientes" }; return m[verdict ?? ""] ?? "—"; }
